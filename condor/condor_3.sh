...
Arguments = run_2.sh --expt_name=5p_pred_cls_g2_rel_words --use_rel_words --reduce_img_feats --expt_data_dir=/scratch/cluster/ankgarg/gqa/test_data/5p/ --test_dirname test_set --gcn_depth=2 --n_attn=512 --n_ans_gate=512 --n_qi_gate=512 --n_ques_emb=512 --bsz=32 --gen_mode=pred_cls
Queue 1
...
Arguments = run_2.sh --expt_name=5p_pred_cls_g1_rel_emb --use_rel_emb --reduce_img_feats --expt_data_dir=/scratch/cluster/ankgarg/gqa/test_data/5p/ --test_dirname test_set --gcn_depth=1 --n_attn=512 --n_ans_gate=512 --n_qi_gate=512 --n_ques_emb=512 --bsz=32 --gen_mode=pred_cls
Queue 1