...
Arguments = run.sh --expt_name=5p_gold_g3 --gcn_depth=3  
Queue 1
...
Arguments = run.sh --expt_name=5p_gold_g4 --gcn_depth=4  
Queue 1
...
Arguments = run.sh --expt_name=5p_gold_g5 --gcn_depth=5  
Queue 1
...
Arguments = run.sh --expt_name=5p_gold_g3_rel --gcn_depth=3 --use_rel_emb 
Queue 1
...
Arguments = run.sh --expt_name=5p_gold_g4_rel --gcn_depth=4 --use_rel_emb 
Queue 1
...
Arguments = run.sh --expt_name=5p_gold_g5_rel --gcn_depth=5 --use_rel_emb 
Queue 1
...
# Arguments = run.sh --expt_name=5p_gold_g5_bce --gcn_depth=5  --critierion=bce
# Queue 1
...
# Arguments = run.sh --expt_name=5p_gold_g5_bce_tanh --gcn_depth=5  --critierion=bce -nl=gated_tanh
# Queue 1
...
# Arguments = run.sh --expt_name=5p_gold_g5_img --gcn_depth=5  --use_img_feats
# Queue 1
