...
from .models.bottom_up_gcn_temp import BottomUpGCN
	...
	def train(self):
		...
		for epoch in range(self.resume_from_epoch, self.num_epochs):
			...
			for i, batch in enumerate(self.train_loader):
				...
				grounding_loss = self.ground_loss(pred_attn_mask, attn_mask)
				batch_loss += (self.lambda_ground * grounding_loss)
