...
class BaseModel(nn.Module):
	def __init__(self, args, word2vec=None, rel_word2vec=None):
		...
		self.v_att = NewAttention(args.n_img_feats, self.q_emb.num_hid, args.n_attn, args.device)
		self.q_net = FCNet([self.q_emb.num_hid, args.n_attn])
		self.v_net = FCNet([args.n_img_feats, args.n_attn])
		self.classifier = SimpleClassifier(args.n_attn, args.n_attn * 2, args.n_ans, 0.5)
